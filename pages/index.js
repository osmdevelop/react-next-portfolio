        ...
        <section className='min-h-full pb-6'>
          ...
          <nav className='py-10 mb-12 flex justify-between'>
            ...
            <ul className='flex items-center w-56 justify-around'>
              ...
              <li>
                <a href="/Resume_OlehSmolikevych.pdf" className='bg-gradient-to-r from-cyan-500 to-teal-500 bg-cyan-500 text-white px-4 py-2 rounded-md hover:from-cyan-500 transition duration-0 hover:duration-150'
                >Resume</a>
              </li>
            </ul>
          </nav>
